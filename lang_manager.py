...
class Manager:
    ...
    def request(self, lang: str, word: str, source: str, multiple=False, format: Optional[str] = ...):
        ...
        :return: returns the requested word from it's a specifed language with its full definition
        """
        from db_maker import cleanhtml
    ...
    def write(self, file, mode, your_data: json or dict, overwrite: bool):
        """
    ...
    def fetch(self, lang, word, directory=f'/Users/{getpass.getuser()}/Library/Application Support/shoutout/lang_storage'):
        """
    ...
    def extract(self, file, path=".", deleteZip=False):
        """
    ...
    def collect(self, action: str, string: str, *files: list):
        """
...
if __name__ == "__main__":
    cool = Manager()
    data = cool.request("pl", "cześć", "wikitonary")
    pprint(data)
